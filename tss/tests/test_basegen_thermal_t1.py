"""tss.tests.test_basegen_thermal_t1 — 基础生成元温感轨 T1 探针（Gate B，r≺）。
...
from tss.relations.probes import snapshot_weights, check_frozen_weights_against
from tss.relations.census import get_relation_generator_stats
