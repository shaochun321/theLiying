"""tss.tests.test_entry_gate — TSS-R1b：PhysicalEntryGate 九项资格测试。
...
from tss.relations.entry_gate import (
...
def test_r1b_9_occurrence_py_untouched():
    """T-R1B-9：occurrence.py 零改动可执行守卫（评判重点 4）。"""
    from tss.generators import occurrence as occ
    ...
    import ast
    import tss.relations.entry_gate as eg
