"""tss.tests.test_r2_fork — P2-C1F：共同源分叉型R2关系验证。
...
from tss.relations.relation_occurrence import RelationFinalizer, RELATION_TYPE_A_PREC_B_FAST
from tss.relations.temporal_r_prec_t2 import RELATION_TYPE_B_PREC_C_FAST
from tss.relations.r2_fork import (
...
def test_r2f_2_reject_different_epoch():
    ...
    from tss.relations.relation_occurrence import RelationOccurrence
