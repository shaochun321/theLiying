...
class BundlePhaseIntensity:
    """TYPE:INFRA — T/O/P/R/Xin intensity for one bundle at one measurement."""
    bundle_id: str = ""
...
class TOPRXinSnapshot:
    """TYPE:INFRA — System-wide T/O/P/R/Xin state at one measurement."""
    tick: int = 0
...
class TOPRXinLedger:
    """TYPE:INFRA — Maps circuit state to T/O/P/R/Xin phase intensities.
