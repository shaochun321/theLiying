"""nexus_v1.tests.test_selection_pool — S0-b：同构候选池验证（不接入竞争）。
...
from nexus_v1.relations.selection_contract import is_valid_candidate_id
from nexus_v1.relations.selection_pool import SelectionPoolCircuit
