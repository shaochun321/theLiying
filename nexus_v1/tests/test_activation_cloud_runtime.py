"""nexus_v1.tests.test_activation_cloud_runtime — TSS-A1：外部发生过程→
内部生成活动云映射运行时闭合测试。
...
from nexus_v1.relations.r1_structure import KappaTen
from nexus_v1.relations.activation_cloud import (
