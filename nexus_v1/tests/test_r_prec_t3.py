"""nexus_v1.tests.test_r_prec_t3 — T3: 28≺21 时间关系构造验证。
...
from nexus_v1.relations.temporal_r_prec_t2 import RPrecCircuitT2
from nexus_v1.relations.temporal_r_prec_t3 import (
