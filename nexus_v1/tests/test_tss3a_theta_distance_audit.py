"""nexus_v1.tests.test_tss3a_theta_distance_audit — TSS-3a：Θ 时间关系在更远
...
from nexus_v1.relations.generator_lambda import N_LOCAL, N_DELTA, SOURCE_SITE
from nexus_v1.relations.temporal_r_prec import (
