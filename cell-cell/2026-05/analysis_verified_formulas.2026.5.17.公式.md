...
**定理**: $P(\text{closest} = \text{acoustic}) \to 0$ 当 $N_{ticks} \to \infty$

**证明**: 对所有 $L > 2$, $|\nabla\Phi_{1/r}(L)| > |\nabla\Phi_{1/r^2}(L)|$

因为 $A/L^2 > 2A/L^3 \Leftrightarrow L > 2$

所有量源距观测者 $L \gg 2$, 因此 acoustic 的梯度力始终最强，
系统被 acoustic 排斥得最远。

> **验证 (N=50)**: P(acoustic closest) = **4%** (2/50) ✅
