...
| ID | 任务描述 | 优先级 | 依赖 | 来源文档 |
|:---|:---|:---|:---|:---|
| T-029 | 能量链修复：ThermalMouth eta 0.02→0.06（Step 4 解除阻塞前置） | 中 | — | R1-Pre 诊断结论 |
...
| ID | 任务描述 | 暂停原因 | 恢复条件 |
|:---|:---|:---|:---|
| T-026 | 饱腹 P0 Step 4：consume_nearby 移除 | R1-Pre FAIL：ThermalMouth(0.034)+YolkSac(0.001)≈神经提取(0.035)，无余量 | T-029（eta 0.02→0.06）完成后重跑 R1-Pre |
